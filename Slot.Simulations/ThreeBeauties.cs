...
using Slot.Games.ThreeBeauties;
using Slot.Games.ThreeBeauties.Models.GameResults;
using Slot.Games.ThreeBeauties.Models.Test;
using Slot.Model;
using System;
using System.Collections.Generic;
using System.Linq;
using System.Threading.Tasks;
using Config = Slot.Games.ThreeBeauties.Configuration.Configuration;

namespace Slot.Simulations
{
    [TestFixture]
    public class ThreeBeauties
    {
        ...
        [TestCase(Config.GameId, Config.LevelOne, "CNY", 1, 1000000, 1, Config.Lines, 1, TestName = "[LVL1-BET1] 1M ThreeBeauties")]
        [TestCase(Config.GameId, Config.LevelOne, "CNY", 1, 1000000, 1, Config.Lines, 2, TestName = "[LVL1-BET2] 1M ThreeBeauties")]
        [TestCase(Config.GameId, Config.LevelOne, "CNY", 1, 200000, 1, Config.Lines, 3, TestName = "[LVL1-BET3] 1M ThreeBeauties")]
        [TestCase(Config.GameId, Config.LevelTwo, "CNY", 1, 1000000, 1, Config.Lines, 1, TestName = "[LVL2-BET1] 1M ThreeBeauties")]
        [TestCase(Config.GameId, Config.LevelTwo, "CNY", 1, 1000000, 1, Config.Lines, 2, TestName = "[LVL2-BET2] 1M ThreeBeauties")]
        [TestCase(Config.GameId, Config.LevelTwo, "CNY", 1, 1000000, 1, Config.Lines, 3, TestName = "[LVL2-BET3] 1M ThreeBeauties")]
        [TestCase(Config.GameId, Config.LevelThree, "CNY", 1, 1000000, 1, Config.Lines, 1, TestName = "[LVL3-BET1] 1M ThreeBeauties")]
        [TestCase(Config.GameId, Config.LevelThree, "CNY", 1, 1000000, 1, Config.Lines, 2, TestName = "[LVL3-BET2] 1M ThreeBeauties")]
        [TestCase(Config.GameId, Config.LevelThree, "CNY", 1, 1000000, 1, Config.Lines, 3, TestName = "[LVL3-BET3] 1M ThreeBeauties")]
        public void TestBets(int gameId, int level, string currencyCode, int numOfUsers, int numItrPerUser, decimal bet, int lines, int mp)
        {
            ...
            Parallel.ForEach(users,
                ...
                (key, state, summaryData) =>
                {
                    ...
                    {
                        var spinResult = new ThreeBeautiesSpinResult() { SpinBet = spinBet }
        ...
        [TestCase(Config.LevelOne, 1, TestName = "[LVL1-BET1] Full Cycle ThreeBeauties")]
        [TestCase(Config.LevelOne, 2, TestName = "[LVL1-BET2] Full Cycle ThreeBeauties")]
        [TestCase(Config.LevelOne, 3, TestName = "[LVL1-BET3] Full Cycle ThreeBeauties")]
        [TestCase(Config.LevelTwo, 1, TestName = "[LVL2-BET1] Full Cycle ThreeBeauties")]
        [TestCase(Config.LevelTwo, 2, TestName = "[LVL2-BET2] Full Cycle ThreeBeauties")]
        [TestCase(Config.LevelTwo, 3, TestName = "[LVL2-BET3] Full Cycle ThreeBeauties")]
        [TestCase(Config.LevelThree, 1, TestName = "[LVL3-BET1] Full Cycle ThreeBeauties")]
        [TestCase(Config.LevelThree, 2, TestName = "[LVL3-BET2] Full Cycle ThreeBeauties")]
        [TestCase(Config.LevelThree, 3, TestName = "[LVL3-BET3] Full Cycle ThreeBeauties")]
