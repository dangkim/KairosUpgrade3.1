...
using Slot.Games.DinoAge;
using Slot.Games.DinoAge.Models;

namespace Slot.Simulations
{
    [TestFixture]
    public class DinoAgeSimulation
    {
        [TestCase(DinoAgeConfiguration.GameId, 1, "CNY", 1, 100000, 1, 10, 1, TestName = "[LVL1] 100K DinoAge Reels")]
        [TestCase(DinoAgeConfiguration.GameId, 1, "CNY", 1, 1000000, 1, 10, 1, TestName = "[LVL1] 1M DinoAge Reels")]
        [TestCase(DinoAgeConfiguration.GameId, 1, "CNY", 1, 10000000, 1, 10, 1, TestName = "[LVL1] 10M DinoAge Reels")]
        [TestCase(DinoAgeConfiguration.GameId, 1, "CNY", 1, 100000000, 1, 10, 1, TestName = "[LVL1] 100M DinoAge Reels")]
        [TestCase(DinoAgeConfiguration.GameId, 1, "CNY", 1, 1000000000, 1, 10, 1, TestName = "[LVL1] 1000M DinoAge Reels")]
        [TestCase(DinoAgeConfiguration.GameId, 2, "CNY", 1, 100000, 1, 10, 1, TestName = "[LVL2] 100K DinoAge Reels")]
        [TestCase(DinoAgeConfiguration.GameId, 2, "CNY", 1, 1000000, 1, 10, 1, TestName = "[LVL2] 1M DinoAge Reels")]
        [TestCase(DinoAgeConfiguration.GameId, 2, "CNY", 1, 10000000, 1, 10, 1, TestName = "[LVL2] 10M DinoAge Reels")]
        [TestCase(DinoAgeConfiguration.GameId, 2, "CNY", 1, 100000000, 1, 10, 1, TestName = "[LVL2] 100M DinoAge Reels")]
        [TestCase(DinoAgeConfiguration.GameId, 2, "CNY", 1, 1000000000, 1, 10, 1, TestName = "[LVL2] 1000M DinoAge Reels")]
        [TestCase(DinoAgeConfiguration.GameId, 3, "CNY", 1, 100000, 1, 10, 1, TestName = "[LVL3] 100K DinoAge Reels")]
        [TestCase(DinoAgeConfiguration.GameId, 3, "CNY", 1, 1000000, 1, 10, 1, TestName = "[LVL3] 1M DinoAge Reels")]
        [TestCase(DinoAgeConfiguration.GameId, 3, "CNY", 1, 10000000, 1, 10, 1, TestName = "[LVL3] 10M DinoAge Reels")]
        [TestCase(DinoAgeConfiguration.GameId, 3, "CNY", 1, 100000000, 1, 10, 1, TestName = "[LVL3] 100M DinoAge Reels")]
        [TestCase(DinoAgeConfiguration.GameId, 3, "CNY", 1, 1000000000, 1, 10, 1, TestName = "[LVL3] 1000M DinoAge Reels")]
        ...
        {
            var alchemySpinResult = sr as DinoAgeSpinResult;
            sdata.SpinCounter++;
            sdata.TotalBet += alchemySpinResult.SpinBet.TotalBet;
            sdata.TotalWin += alchemySpinResult.Win;
        }

        private void UpdateDinoAgeSummaryData(SummaryData sd, SpinResult sr)
        {
            var alchemySpinResult = sr as DinoAgeSpinResult;
