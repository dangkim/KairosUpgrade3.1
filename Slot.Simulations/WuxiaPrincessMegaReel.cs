namespace Slot.Simulations
{
    ...
    using Slot.Games.WuxiaPrincess;
    using System;
    using System.IO;
    using System.Linq;

    [TestFixture]
    public class WuxiaPrincessMegaReel
    {
        private const int GameId = 76;
        ...
        public void Settup()
        {
            ...
            var logger = logFactory.CreateLogger<WuxiaPrincessModule>();
            module = new WuxiaPrincessModule(logger);
        }

        [TestCase(1, 1000, 1000, 1.0, TestName = "[LVL1][1M] Wuxia Princess")]
        [TestCase(1, 1000, 10000, 1.0, TestName = "[LVL1][10M] 1st Wuxia Princess")]
        [TestCase(1, 1000, 10000, 1.0, TestName = "[LVL1][10M] 2nd Wuxia Princess")]
        [TestCase(1, 1000, 10000, 1.0, TestName = "[LVL1][10M] 3rd Wuxia Princess")]
        [TestCase(1, 10000, 10000, 1.0, TestName = "[LVL1][100M] 1st Wuxia Princess")]
        [TestCase(1, 10000, 10000, 1.0, TestName = "[LVL1][100M] 2nd Wuxia Princess")]
        [TestCase(1, 10000, 10000, 1.0, TestName = "[LVL1][100M] 3rd Wuxia Princess")]

        [TestCase(2, 1000, 10000, 1.0, TestName = "[LVL2][10M] 1st Wuxia Princess")]
        [TestCase(2, 1000, 10000, 1.0, TestName = "[LVL2][10M] 2nd Wuxia Princess")]
        [TestCase(2, 1000, 10000, 1.0, TestName = "[LVL2][10M] 3rd Wuxia Princess")]
        [TestCase(2, 10000, 10000, 1.0, TestName = "[LVL2][100M] 1st Wuxia Princess")]
        [TestCase(2, 10000, 10000, 1.0, TestName = "[LVL2][100M] 2nd Wuxia Princess")]
        [TestCase(2, 10000, 10000, 1.0, TestName = "[LVL2][100M] 3rd Wuxia Princess")]
