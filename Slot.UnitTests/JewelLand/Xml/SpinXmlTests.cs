...
namespace Slot.UnitTests.JewelLand.Xml
{
    ...
    public class SpinXmlTests
    {
        ...
        [TestCase(Levels.One, TestName = "JewelLand-WriteXmlOfSpinResultXml")]
        ...
        [TestCase(Levels.One, TestName = "JewelLand-CopySpinValuesFromSpinToXml")]
        ...
        [TestCase(Levels.One, TestName = "JewelLand-ShouldCopyWinPositionsFromSpinToXml")]
        ...
        [TestCase(Levels.One, TestName = "JewelLand-ShouldCopyWheelReelsFromSpinToXml")]
